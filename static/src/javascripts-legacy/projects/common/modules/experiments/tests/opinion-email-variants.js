...
export default function() {
    ...
    this.successMeasure =
        'We can trial two different email formats to fairly compare their CTO rates';
    this.audienceCriteria = 'All users who visit the email sign up page';
    this.dataLinkNames = '';
    this.idealOutcome =
        '90% of users in new format list, 10% in the other list';
    ...
    this.canRun = function() {
        return (
            config.page.contentId === OPINION_URL ||
